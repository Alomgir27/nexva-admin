          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full relative z-10">
            ...
            <div className="relative flex items-center justify-center min-h-[400px]">
              ...
              <div className="relative z-10 text-center">
                <h2 
                  className="text-[8rem] lg:text-[10rem] font-black uppercase leading-none select-none mb-8"
                  style={{
                    color: 'var(--bg-bg-brand)',
                    WebkitTextStroke: '2px var(--bg-bg-brand)',
                    textShadow: '0 0 50px rgba(50, 240, 140, 0.4)',
                ...
                <div className="flex items-center justify-center space-x-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-mono text-[var(--text-text-tertiary)] tracking-wider">AI POWERED</span>
                  </div>
                  <div className="h-4 w-px bg-[var(--border-border-neutral-l1)]" />
                  <div className="flex items-center space-x-2">
                    <span className="text-xs font-mono text-[var(--text-text-tertiary)] tracking-wider">v1.0</span>
...
{example.code}
      ...
      <footer className="relative border-t border-[var(--border-border-neutral-l1)] bg-[var(--bg-bg-base-secondary)] overflow-hidden pb-48">
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              <h3 className="font-semibold text-[var(--text-text-default)] mb-4">Product</h3>
              <ul className="space-y-3">
                <li><Link href="#features" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Features</Link></li>
                <li><Link href="#pricing" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Pricing</Link></li>
                <li><Link href="/docs" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Documentation</Link></li>
                <li><Link href="/dashboard" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Dashboard</Link></li>
                <li><Link href="/playground" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Playground</Link></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-[var(--text-text-default)] mb-4">Company</h3>
              <ul className="space-y-3">
                <li><Link href="/about" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">About</Link></li>
                <li><Link href="/blog" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Blog</Link></li>
                <li><Link href="/contact" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Contact</Link></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-[var(--text-text-default)] mb-4">Legal</h3>
              <ul className="space-y-3">
                <li><Link href="/privacy" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Privacy</Link></li>
                <li><Link href="/terms" className="text-sm text-[var(--text-text-tertiary)] hover:text-[var(--bg-bg-brand)] transition-colors">Terms</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-[var(--border-border-neutral-l1)] flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-[var(--text-text-tertiary)]">© 2025 Nexva. All rights reserved.</p>
      ...
      <div className="fixed bottom-0 left-0 w-full pointer-events-none z-0 overflow-hidden">
        <div className="relative w-full h-48 flex items-center justify-center px-8">
          <h1 
            className="text-[clamp(10rem,25vw,20rem)] uppercase select-none opacity-20"
            style={{
              fontFamily: 'var(--font-family-default)',
              fontWeight: 900,
              color: 'var(--bg-bg-brand)',
              WebkitTextStroke: '2px var(--bg-bg-brand)',
              textShadow: '0 0 30px rgba(50, 240, 140, 0.3)',
              letterSpacing: '0',
            }}
          >
            NEXVA
